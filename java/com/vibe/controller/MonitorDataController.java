...
public class MonitorDataController {
    ...
    public @ResponseBody
    Map<String, Object> getRecentData(@PathVariable("monitorId") int monitorId) {
    ...
    public @ResponseBody
    Map<String, Object> getRecentLineValues(CommonMonitorDataVo vo, @RequestParam(defaultValue = "1") Integer page,
    ...
    public @ResponseBody
    List<Asset<?>> totalLeftSpace(@RequestParam(defaultValue = "0") Integer parentId) {
    ...
    */
    ...
    public @ResponseBody
    Map<String, Object> getMonitorDataRegression(Integer monitorId1, Integer monitorId2,
        ...
        List<Double> list = (List<Double>) lines.get(0).get("values");

        List<Double> list2 = (List<Double>) lines.get(1).get("values");
    ...
    public @ResponseBody
    Map<String, Object> getComparedValues(int monitorId1, int monitorId2, String filterType,
                                          String startTime, String lastTime, @RequestParam(defaultValue = "1") Integer page,
                                          @RequestParam(defaultValue = "20") Integer rows) {
    ...
    public @ResponseBody
    Map<String, Object> getCalComparedData(String filterType, int monitorId1, int monitorId2,
                                           String startTime, String lastTime, @RequestParam(defaultValue = "1") Integer page,
                                           @RequestParam(defaultValue = "20") Integer rows) {
    ...
    public @ResponseBody
    Map<String, Object> querySingleMonitorData(CommonMonitorDataVo vo,
    ...
    public @ResponseBody
    Map<String, Object> getMonitorLineValues(CommonMonitorDataVo vo,
                                             @RequestParam(defaultValue = "1") Integer page, @RequestParam(defaultValue = "20") Integer rows) {
