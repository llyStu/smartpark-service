...
public class MonitorController {
	...
	public @ResponseBody Object initMonitorList(Integer catalog, @RequestParam(defaultValue = "0") Integer spaceId,
	...
	public @ResponseBody Object initMonitorTree(Integer catalog, @RequestParam(defaultValue = "0") Integer spaceId,
	...
	public @ResponseBody Map<String, Object> initMonitorListPage(@RequestParam(defaultValue = "0") int catalog,
	...
	public @ResponseBody List<ProbeValue> probeValue(String ids) {
		return monitorService.getProbeValue(ids);
	}

	@RequestMapping("/device_data/probeHistoryValue")
	public @ResponseBody Map<String , Object> probeHistoryValue(HistoryDataCondition hdc, @RequestParam(defaultValue = "1") Integer page,
