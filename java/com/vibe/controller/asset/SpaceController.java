...
public class SpaceController {
	...
	public @ResponseBody List<TreeNode>  allTreeData( @RequestParam(defaultValue="0",value="id") Integer parent){
		List<TreeNode> treeList=assetService.getAllSpaceTree(parent);
		return treeList;
	}	
	/*加载树节点下的数据*/
	@RequestMapping("/space/spaceList")
	public @ResponseBody EasyUIJson  spaceList(AssetVo assetVo,@RequestParam(defaultValue="10")Integer rows, @RequestParam(defaultValue="1")Integer page){
	...
	public @ResponseBody String  addSpace(Space space){
		try {
	...
	public @ResponseBody AssetVo spaceDetail(@PathVariable Integer id) throws AssetException {
