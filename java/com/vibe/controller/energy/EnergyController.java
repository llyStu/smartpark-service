...
public class EnergyController {
    ...
    public @ResponseBody
    EasyUIJson queryEnergyDataListByPage(CommonMonitorDataVo vo,
    ...
    public @ResponseBody
    Map<String, Object> queryEnergyDataEcart(CommonMonitorDataVo vo) {
   ...
   /* @RequestMapping(value="/energy/carbonDataList")
    ...
    public @ResponseBody
    List<Ratio> getItemRatio(CommonMonitorDataVo vo) {
