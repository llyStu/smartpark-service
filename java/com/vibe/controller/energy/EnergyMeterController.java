...
public class EnergyMeterController {
    ...
    public @ResponseBody
    List<TreeNode> queryEnergyDataListByPage(Meter meter) {
    ...
    public @ResponseBody
    EasyUIJson queryMeterList(Meter meter,
    ...
    public @ResponseBody
    String deleteMeter(String ids) {//0,不删，1是删
    ...
    public @ResponseBody
    List<TreeNode> queryDummyMeter(Integer catalogId) {
    ...
    public @ResponseBody
    String addDummyMeter(Meter meter) {
        try {
       		/*IdGenerator<Integer> gen = application.getIntIdGenerator("asset");
   			int id = gen.next();
   			meter.setId(id);*/
    ...
    public @ResponseBody
    ResponseModel imEnergyMeter(@RequestParam(value = "file") MultipartFile file) {
    ...
    public @ResponseBody
    EasyUIJson queryRelationMeterList(MeterRelation meterRelation,
