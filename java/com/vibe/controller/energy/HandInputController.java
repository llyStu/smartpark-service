...
public class HandInputController {
	...
	public @ResponseBody Response insertHandInput(HttpServletRequest request, @RequestBody List<HandInputData> datas) {
	...
	public @ResponseBody Response updateHandInput(@RequestBody HandInputData data) {
	...
	public @ResponseBody PageResult<HandInputData> findHandInput(
	...
	public @ResponseBody Response deleteHandInput(@RequestParam("idStr") String idStr) {
		try {
	...
	public @ResponseBody List<HandInputProbe> getHandInputProbe() {
