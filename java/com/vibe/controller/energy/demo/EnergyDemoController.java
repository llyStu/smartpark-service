...
public class EnergyDemoController {
	...
	public @ResponseBody Map<String, Object> queryEnergyDemoListByPage(CommonMonitorDataVo vo,
	...
	public @ResponseBody  Map<String,Object> selectValue (Integer id,Integer monitorId){
		return energyDemo.selectValue(id, monitorId);
	}
	//分项显示的饼图 flag是空间还是类型
	@RequestMapping("/demo/classify")
	public @ResponseBody Map<String, Object> getClassifyValue(Integer id,String flag){
		//return energyDemo.getClassifyValue(monitorId);
		return energyDemo.getClassifyValue(id, flag);
	}
	
	@RequestMapping("/demo/data")
	public @ResponseBody Map<String, Data> getData(){
