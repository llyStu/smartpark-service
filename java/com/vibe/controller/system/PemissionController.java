...
public class PemissionController {
    ...
    public @ResponseBody
    EasyUIJson querypermissionList(Permission permission, @RequestParam(defaultValue = "1") Integer page,
    ...
    public @ResponseBody
    String permissionAdd(Permission permission) {
        try {
    ...
    public @ResponseBody
    List<Permission> permissionDetail(@PathVariable String ids) {
    ...
    public @ResponseBody
    String deletePermission(String ids) {
        try {
