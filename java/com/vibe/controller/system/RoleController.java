...
public class RoleController {
	...
	public @ResponseBody EasyUIJson queryroleList(Role role, @RequestParam(defaultValue = "1") Integer page,
	...
	public @ResponseBody String roleAdd(Role role) {
		try {
	...
	public @ResponseBody List<Permission> queryUserPermission(Integer id) {
	...
	public @ResponseBody String updateRolePermission(Integer id,String pids) {
		try {
	...
	public @ResponseBody List<Role> roleDetail(@PathVariable String ids) {
