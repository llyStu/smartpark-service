...
public class UserController {
    ...
    public @ResponseBody
    Boolean queryUserByLoginId(String loginId) {
...
//			user.setId(gen.next());
    ...
    public @ResponseBody
    List<User> userDetail(@PathVariable String ids) {
    ...
    public @ResponseBody
    List<AllTreeNode> initTree(@RequestParam(defaultValue = "00") Integer parent) {
    ...
    public @ResponseBody
    List<UserPermission> queryUserPermission(Integer id) {
