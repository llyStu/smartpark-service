            ...
            for (Energy id : floorId) {
                ...
                if (!floorElecList.isEmpty() && floorElecList != null) {
                    for (int i = 0; i < floorElecList.size(); i++) {
                        ...
                        switch (elec) {
                            case 44:
                                rankEnergy.setKtElec(value);
                                break;
                            case 45:
                                rankEnergy.setZmElec(value);
                                break;
                            case 46:
                                rankEnergy.setZhElec(value);
                                break;
                            case 47:
                                rankEnergy.setDlElec(value);
                                break;
                            case 48:
                                rankEnergy.setTsElec(value);
                                break;
                        }
                ...
                if (!floorWaterList.isEmpty() && floorWaterList != null) {
                    for (int i = 0; i < floorWaterList.size(); i++) {
                        ...
                        switch (water) {
                            case 50:
                                rankEnergy.setShWater(value);
                                break;
                            case 51:
                                rankEnergy.setWsWater(value);
                                break;
                        }
