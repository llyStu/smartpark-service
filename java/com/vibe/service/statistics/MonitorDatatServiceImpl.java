...
//							 String date = simpleDateFormat.format(moment);
    ...
    public Map<String, Object> querySingleMonitorData(CommonMonitorDataVo vo, Integer page, Integer rows) {
        ...
        List<Object> xAxis = new LinkedList<Object>();
        List<Object> minValues = new LinkedList<Object>();
        List<Object> maxValues = new LinkedList<Object>();
        List<Object> avgValues = new LinkedList<Object>();
        List<Object> stdValues = new LinkedList<Object>();
        for (MonitorData data : loadRecently) {

            //xAxis.add(new SimpleDateFormat("yyyy-MM-dd").format(data.getStr_moment()).substring(0,10));
            xAxis.add(data.getStr_moment());
            minValues.add(data.getMinData());
            maxValues.add(data.getMaxData());
            avgValues.add(data.getAvgData());
            stdValues.add(data.getStdData());
        }
...
//				re_map.put("2", 3);	
    ...
    public Map<String, Object> queryMonitorData(CommonMonitorDataVo vo, Integer page, Integer rows) {
        ...
        List<Double> format_values = new LinkedList<Double>();
        for (Object value : values) {

            format_values.add(ScaleUtil.roundObject(value));
        }
        map.put("unit", unit);
        map.put("xAxis", xAxis);
